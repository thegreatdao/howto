...
public class EmployeeSpringJdbcImpl implements EmployeeDao
{
	...
	{
		String sql = "insert into employee (first_name, last_name, age, gender, department_id, insurance_policy_id) " +
				"values (:firstName, :lastName, :age, :gender, :departmentId, :insurancePolicyId)";
		Map<String, Object> parameters = new HashMap<String, Object>();
		...
		parameters.put("gender", employee.getLastName());
