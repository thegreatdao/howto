...
--%><%
    ...
    if (jClass.isAnnotationPresent(javax.jdo.annotations.Version.class)) {
    	// Get JDO version field using specific DataNucleus extension
    	javax.jdo.annotations.Version versionAnnotation = jClass.getType().getAnnotation(javax.jdo.annotations.Version.class);
    	...
    	for (javax.jdo.annotations.Extension extension : extensions) {
    		if ("datanucleus".equals(extension.vendorName()) && "field-name".equals(extension.key())) {
    			versionFieldName = extension.value();
    			break;
    		}
    	}
    }
    for (jProperty in jClass.properties) {
        if (jProperty.getName().equals(versionFieldName) || jProperty.isAnnotationPresent(Version.class)) {
